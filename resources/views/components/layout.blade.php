    ...
    <div id="mobile-menu" class="md:hidden">
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Ramon Rius</div>
            <div class="text-sm font-medium text-gray-400">rmnrius@gmail.com</div>
          </div>
