                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2">
                            ...
                            <input id="title" type="text" name="title" placeholder="Mona Lisa" class="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6"  required/>
                            </div>
                            @error('title')
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2">
                            <div class="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                            <input id="price" type="text" name="price" placeholder="₱1,234" class="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" required/>
                            </div>
                            @error('price')
                                <p class="mt-2 text-sm/6 text-red-600">{{ $message }}</p>
                            @enderror
